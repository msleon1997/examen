...
function listProducts() {
    ...
    fetch("http://localhost/examen/backend/listProducts.php")
    // --
...
function renderProductCard(product){
    ...
    productImage.setAttribute('class', 'cart-products');
...
function order(){
    ...
    fetch("http://localhost/examen/backend/order.php", {method:'post', body:jsonOrder})
